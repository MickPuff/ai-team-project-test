...
- [ ] Codex (Mick): integration lead, repo structure, architecture, GitHub workflow
- [ ] Gemini 1 (Kelly): business process discovery, pain points, stakeholder workflow mapping
- [ ] Gemini 2 (Anda): database, spreadsheet inventory, data cleaning, source data profiling
